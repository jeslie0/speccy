module Colourmaps.Viridis (viridisColourMapRefined) where
...
viridisColourMapRefined :: Number -> { r :: Number, g :: Number, b :: Number, a :: Number }
viridisColourMapRefined =
  colourMapDataToFunctionRefined viridisData

viridisData :: Array (Array Number)
viridisData =
